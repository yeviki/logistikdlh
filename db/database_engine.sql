...
--
-- Host: 127.0.0.1
-- Generation Time: 23 Mar 2021 pada 06.12
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(1, 'SISFO - DIKLAT', 'Badan Pengembangan Sumber Daya Manusia', 'Sisfo Diklat', '2021', 'logo_sumbar.png', 'favicon.ico', 'Aplikasi Sisfo Diklat', '1.0.0');
...
--
ALTER TABLE `xi_sa_log_session`
MODIFY `id_log_session` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=205;
--
