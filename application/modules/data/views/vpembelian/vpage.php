                ...
                <div class="row">
                    <div class="col-12 col-md-12 clearfix mb-3">
                        ...
                        <div class="float-right" style="display: none;" id="eventButoon">
                            ...
                            <button class="btn btn-info waves-effect waves-light px-3 py-2 mx-0 font-weight-bold" type="button" id="btnUpdateStok" disabled=""><i class="fas fa-truck"></i> Update Stok</button>
                        </div>
                    </div>
                    <div class="col-12 col-md-12">
