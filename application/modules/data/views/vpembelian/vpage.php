    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" id="frmEntry">
        <div class="modal-content">
            <div class="modal-header aqua-gradient-rgba">
                <h4 class="modal-title heading lead white-text font-weight-bold"><i class="fas fa-edit"></i> Form Entri Pembelian Barang</h4>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl" id="frmDetailPem">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-12 clearfix mb-3">
                        <div class="float-left">
                            <button class="btn btn-success waves-effect waves-light px-3 py-2 mx-0 font-weight-bold btnDetail" type="button"><i class="fas fa-plus-circle"></i> Setting Mata Diklat</button>
                        </div>
                    ...
                    <div class="col-12 col-md-12 clearfix mb-3" id="formSettingMataDiklat" style="display: none;">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo form_hidden('tokenMataDik', ''); ?>
                                <div class="form-row mb-3 ">
                                    <div class="col-12 col-md-4 required">
                                        <label for="id_widyaiswara" class="control-label font-weight-bolder">Nama Widyaiswara <span class="text-danger">*</span></label>
                                        <?php echo form_dropdown('id_widyaiswara', isset($data_widyaiswara) ? $data_widyaiswara : array(''=>'Pilih Data'), $this->input->post('id_widyaiswara', TRUE), 'class="form-control select-all" id="id_widyaiswara" required=""');?>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-12 col-md-6 required">
                                        <label for="id_mata_diklat" class="control-label font-weight-bolder">Nama Mata Diklat <span class="text-danger">*</span></label>
                                        <?php echo form_dropdown('id_mata_diklat', isset($data_mata_diklat) ? $data_mata_diklat : array(''=>'Pilih Data'), $this->input->post('id_mata_diklat', TRUE), 'class="form-control select-all" id="id_mata_diklat" required=""');?>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-12 col-md-2 required">
                                        ...
                                        <?php echo form_dropdown('status', status(), $this->input->post('status', TRUE), 'class="form-control select-data" id="status" required=""');?>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="form-row mb-3">
                                    <div class="col-12 col-md-3 required">
                                        <label for="id_hari" class="control-label font-weight-bolder">Hari <span class="text-danger">*</span></label>
                                        <?php echo form_dropdown('id_hari', isset($data_hari) ? $data_hari : array(''=>'Pilih Data'), $this->input->post('id_hari', TRUE), 'class="form-control select-all" id="id_hari" required=""');?>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-12 col-md-3 required">
                                        <label for="jam_mulai" class="control-label font-weight-bolder">Jam Mulai <span class="text-danger">*</span></label>
                                        <input type="time" id="default-picker" class="form-control" placeholder="Select time" name="jam_mulai" id="jam_mulai" value="<?php echo $this->input->post('jam_mulai', TRUE); ?>" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-12 col-md-3 required">
                                        <label for="jam_selesai" class="control-label font-weight-bolder">Jam Selesai <span class="text-danger">*</span></label>
                                        <input type="time" id="default-picker" class="form-control" placeholder="Select time" name="jam_selesai" id="jam_selesai" value="<?php echo $this->input->post('jam_selesai', TRUE); ?>" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-12 col-md-3 required">
                                        <label for="jumlah_jp" class="control-label font-weight-bolder">Jumlah JP <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control nominal" name="jumlah_jp" id="jumlah_jp" placeholder="JP" value="<?php echo $this->input->post('jumlah_jp', TRUE); ?>" required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="form-row">
                ...
                <div class="table-responsive-md">
                    <h5 class="heading font-weight-bold"><i class="fas fa-list"></i> Daftar Mata Diklat <span class="lblMataDiklat"></span></h5>
                    <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblMata" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th class="font-weight-bold text-left">Widyaiswara</th>
                                <th class="font-weight-bold text-left">Mata Diklat</th>
                                <th class="font-weight-bold text-left">Hari</th>
                                <th class="font-weight-bold text-left"> Mulai</th>
                                <th class="font-weight-bold text-left"> Selesai</th>
                                <th class="font-weight-bold text-center">JP</th>
