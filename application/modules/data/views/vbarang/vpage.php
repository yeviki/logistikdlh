                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="50%" class="font-weight-bold">Nama Diklat</th>
            ...
            <div class="modal-body">
                ...
                <div class="form-row mb-3">
                    <div class="col-12 col-md-10 required">
                        <label for="nm_mata_diklat" class="control-label font-weight-bolder">Mata Diklat <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="nm_mata_diklat" id="nm_mata_diklat" placeholder="Nama Mata Diklat" value="<?php echo $this->input->post('nm_mata_diklat', TRUE); ?>" required>
