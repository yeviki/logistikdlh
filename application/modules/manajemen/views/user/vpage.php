                        ...
                        <table cellspacing="0" class="table table-striped table-borderless table-hover table-sm" id="tblList" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="45%" class="font-weight-bold">Group</th>
                            ...
                            <?php foreach ((isset($data_group) ? $data_group : array()) as $key => $dg) {
                                echo '<div class="col-4">';
                                    echo '<div class="custom-control custom-checkbox required">';
                                        echo '<input type="checkbox" class="custom-control-input" name="groupid[]" id="groupid_'.$dg['id_group'].'" value="'.$this->encryption->encrypt($dg['id_group']).'" '.set_checkbox('groupid[]', $this->encryption->encrypt($dg['id_group'])).' required>';
